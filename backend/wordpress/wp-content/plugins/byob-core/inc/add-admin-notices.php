 ...
 */
function byob_admin_notice_frontend_app_url_error() {
...
if ( ! defined( 'FRONTEND_APP_URL' ) ) {
	add_action( 'admin_notices', 'byob_admin_notice_frontend_app_url_error' );
}

/**
 * Warning notice for plugins screens.
 */
function byob_admin_notice_plugins_warning() {
...
if ( in_array( $pagenow, array( 'plugins.php', 'plugin-install.php' ), true ) ) {
	add_action( 'admin_notices', 'byob_admin_notice_plugins_warning' );
}

/**
 * Warning notice for settings screens.
 */
function byob_admin_notice_settings_warning() {
	$class   = 'notice notice-warning is-dismissible';
	$message = '
		<b>Warning! Advanced users only.</b>
...
if ( in_array( $pagenow, array( 'options-general.php', 'options-writing.php', 'options-reading.php', 'options-media.php', 'options-permalink.php' ), true ) ) {
	add_action( 'admin_notices', 'byob_admin_notice_settings_warning' );
}
